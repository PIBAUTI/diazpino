    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          email: site.email,
          address: { "@type": "PostalAddress", addressLocality: "Caracas", addressCountry: "VE", streetAddress: "Los Chaguaramos" },
          areaServed: "VE",
          sameAs: [site.social.facebook, site.social.instagram, site.social.linkedin, site.social.x],
        }),
      },
    ],
  }),
